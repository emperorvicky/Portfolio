...
export default function Layer1() {
    ...
    <div>
        <section className="m-3">
            ...
            <div className="bg-neutral-900 rounded-md p-3 m-2 sm:p-5 shadow-lg">
                <p className={`${itimFont.className} text-justify text-white sm:text-lg md:text-xl lg:text-2xl sm:p-7 md:p-12`}>
